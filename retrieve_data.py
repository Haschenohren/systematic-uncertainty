...
#big bad regex: determines species, charge, collision system, centrality, value (inv. yield or nmf)
re_nmf_cs = r'(?P<nmf_cs>raa|rda)' #nuclear modification factor in collision system
...
def systematic_uncertainty(particle, collision, p_T, value):
    ...
    return _uncertainty_table[row][col] * value
